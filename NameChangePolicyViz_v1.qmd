...
-   Several publishers offer a variety of options for silent vs. in-print changes
    ...
    -   More options = more freedom?
        ...
        -   Contacting co-authors/corresponding authors
            ...
            -   Most leave any contact up to the author indepdendently, but some offer to be the contacter and a few require that the corresponding author be contacted in order for the article to be changed.
