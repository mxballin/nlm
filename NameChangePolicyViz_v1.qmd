...
"publishers",15.4,2.6,17.9,48.7,15.4
)
...
"Lippincott, Williams & Wilkins",128,2021,TRUE,TRUE,FALSE,FALSE,FALSE,TRUE,NA,FALSE,TRUE,NA,FALSE,NA,
"IEEE",93,2021,TRUE,TRUE,TRUE,FALSE,TRUE,FALSE,"FORM",TRUE,TRUE,TRUE,TRUE, "Will only update citations in IEEE publications",
"Dove Medical Press",73,2021,TRUE,FALSE,TRUE,FALSE,FALSE,FALSE,"FORM",FALSE,TRUE,NA,FALSE, NA,
"BMJ (British Medical Association)",67,2021, TRUE,TRUE,TRUE,FALSE,TRUE,TRUE,"EMAIL",TRUE,TRUE,FALSE,FALSE,NA,
"Taylor & Francis",66,2021,TRUE,FALSE,TRUE,FALSE,FALSE,FALSE,"EMAIL",FALSE,TRUE,NA,FALSE,NA,
